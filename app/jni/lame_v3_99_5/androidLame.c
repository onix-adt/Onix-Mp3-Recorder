...
JNIEXPORT void JNICALL Java_com_lame_encoder_core_LameCore_initializeDefault(
        JNIEnv *env, jclass cls) {

    glf = initializeDefault(env);
}

JNIEXPORT void JNICALL Java_com_onix_recorder_lame_core_LameCore_initialize(
...
JNIEXPORT jint JNICALL Java_com_onix_recorder_lame_core_LameCore_lameEncode(
...
JNIEXPORT jint JNICALL Java_com_onix_recorder_lame_core_LameCore_encodeBufferInterleaved(
        JNIEnv *env, jclass cls, jshortArray pcm,
        jint samples, jbyteArray mp3buf) {
    return encodeBufferInterleaved(env, glf, pcm, samples, mp3buf);
}

JNIEXPORT jint JNICALL Java_com_onix_recorder_lame_core_LameCore_lameFlush(
        JNIEnv *env, jclass cls, jbyteArray mp3buf) {
    return flush(env, glf, mp3buf);
}

JNIEXPORT void JNICALL Java_com_onix_recorder_lame_core_LameCore_lameClose(
        JNIEnv *env, jclass cls) {
    close(glf);
}
